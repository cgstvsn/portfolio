...
import SkillHover from "./_components/SkillHover";
      ...
      <div className='flex flex-col gap-4 w-full'>
        <div className='flex justify-between'>
          <div>
            ...
            <h1 className='text-6xl font-bold text-zinc-800 w-0 wrap'>
              Cameron Gustavson
            </h1>
          </div>
        </div>
    ...
    <main className='w-full max-w-7xl mx-auto min-h-screen px-4 sm:px-8'>
      ...
      <div className='flex gap-3 mt-3'>
        <Image
          src={Me}
          alt='A photo of me'
          className='basis-1/3 aspect-square w-full bg-white rounded-2xl shadow-lg saturate-0 hidden lg:block'
        />
        <div className='basis-2/3 w-full bg-white rounded-2xl px-8 py-4 shadow-lg'>
          ...
          <div className='flex gap-2 mb-4 flex-wrap'>
            <SkillHover label='ReactJS'>
              <svg viewBox='0 0 512 512' fill='currentColor' className='w-12'>
            ...
            <SkillHover label='Tailwind CSS'>
              <svg viewBox='0 0 24 24' fill='currentColor' className='w-12'>
            ...
            <SkillHover label='Javascript'>
              <svg viewBox='0 0 32 32' fill='currentColor' className='w-12'>
          ...
          <p className='mb-1 text-zinc-500'>Design</p>
