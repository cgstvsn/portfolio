  ...
  return (
    ...
    <div className='w-full lg:w-[80%] mx-auto flex flex-col gap-4 my-8 px-6 lg:px-8'>
      ...
      <div className='w-full aspect-[3/2] rounded-lg overflow-hidden'>
        <ImageCard imgSrc={football4} large priority />
      </div>
      ...
      <div className='flex flex-col md:flex-row gap-4 justify-center'>
        <div className='w-full aspect-[2/3] rounded-lg overflow-hidden'>
          <ImageCard imgSrc={bball} large />
        </div>
        <div className='w-full aspect-[2/3] rounded-lg overflow-hidden'>
          <ImageCard imgSrc={football2} large />
        </div>
      </div>

      {/* full image */}
      <div className='w-full aspect-[3/2] rounded-lg overflow-hidden'>
        <ImageCard imgSrc={horse4} large />
      </div>
      ...
      <div className='flex flex-col md:flex-row gap-4 justify-center'>
        <div className='w-full aspect-[3/2] rounded-lg overflow-hidden'>
          <ImageCard imgSrc={rowing6} priority />
        </div>
        <div className='w-full aspect-[3/2] rounded-lg overflow-hidden'>
          <ImageCard imgSrc={rowing1} priority />
        </div>
        <div className='w-full aspect-[3/2] rounded-lg overflow-hidden'>
          <ImageCard imgSrc={rowing2} priority />
        </div>
      </div>
      ...
      <div className='flex flex-col md:flex-row gap-4 justify-center'>
        <div className='w-full aspect-[3/2] rounded-lg overflow-hidden'>
          <ImageCard imgSrc={rowing3} priority />
        </div>
        <div className='w-full aspect-[3/2] rounded-lg overflow-hidden'>
          <ImageCard imgSrc={rowing4} priority />
        </div>
        <div className='w-full aspect-[3/2] rounded-lg overflow-hidden'>
          <ImageCard imgSrc={rowing5} priority />
        </div>
      </div>

      {/* full image */}
      <div className='w-full aspect-[3/2] rounded-lg overflow-hidden'>
        <ImageCard imgSrc={football6} large />
      </div>
      ...
      {/* full image */}
      <div className='w-full aspect-[3/2] rounded-lg overflow-hidden'>
        <ImageCard imgSrc={football15} large />
      </div>
    </div>
  );
};
