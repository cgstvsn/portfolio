function SkillHover(props: any) {
  ...
  return (
    <div className='group relative'>
      ...
      <div className='flex items-center justify-center rounded-xl font-semibold bg-zinc-100 h-14 p-4 text-zinc-800 select-none hover:bg-zinc-800 hover:text-zinc-100 transition'>
        {children}
      </div>
    </div>
  );
