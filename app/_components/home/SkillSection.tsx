              ...
              >
                <Disclosure.Panel className='lg:grid lg:grid-cols-4'>
                    <div className="w-full col-start-2 col-span-3">
                      <h2 className="font-bold text-center lg:text-left my-8">Other skills</h2>
                      <ul className="flex gap-8 flex-wrap justify-center lg:justify-start mt-2 list-disc lg:pl-[18px]">
                        <li>LUA Scripting</li>
